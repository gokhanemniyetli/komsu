...
import { Text, View, ScrollView, Image, TouchableOpacity, FlatList, Linking,  Alert, KeyboardAvoidingView, Platform, SafeAreaView } from 'react-native';
            ...
            <View>
                ...
                <View style={container.row.sa}>
                    ...
                    {this.state.friendCount <= 3 ?
                        null
                        :
                        <TouchableOpacity style={[container.center.center, { padding: 5, borderWidth: 0.5, borderRadius: 10, borderColor: 'lightgray' }]} onPress={() => Actions.userSortScreen({ ID: this.props.ID, requestType: 'friends', title: Localizations('Screen.FriendScreen') })}>
